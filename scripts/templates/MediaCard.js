...
class MediaCard {
    ...
    createMediaCard() {
        ...
        if (this._media.image != 'undefined') {
          ...
          media = `<video controls width="350" height="300"><source src="/assets/photographers/${this._media.video}" type="video/mp4" /></video>`
        }
        ...
        `
          <div class="main__galerie__project__info">
            ...
            <div class="main__galerie__project__info__heart">
              ...
              <div class="main__galerie__project__info__heart__wish-btn">
