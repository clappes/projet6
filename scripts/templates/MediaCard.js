...
class MediaCard {
    ...
    createMediaCard() {
        ...
        if (this._media._image) {
          media = `<a href="/assets/photographers/${this._media.image}" data-alt="${this._media.title}" ><img class="main__galerie__project__img" src="/assets/photographers/${this._media.image}" alt="${this._media.title}" width="350" height="300"></img></a>`
        } else {
          media = `<a href="/assets/photographers/${this._media.video}" data-alt="${this._media.title}" ><video width="350" height="300" style="object-fit: cover;border-radius: 5px;" ><source src="/assets/photographers/${this._media.video}" type="video/mp4" /></video></a>`
        }
        ...
        `
          <div class="main__galerie__project__info">
            ...
            <div class="main__galerie__project__info__heart">
              ...
              <div data-id="count-${this._media.id}-id" aria-label="Bouton pour liker" tabindex="0" class="main__galerie__project__info__heart__wish-btn">
